    ...
    methods: {
        ...
        getData () {
            ...
            if (!this.async) {
                ...
                this.param.currentPage = this.pages[this.activeNum] || this.sessionStorageAcctive+1;
                ...
                commFun.request({
                    ...
                    success: function (response) {
                        self.pageTotal = Math.ceil(response.total / response.pageSize);
                        ...
                        self.$dispatch('data', response.objects)
                    },
